...
t_spi_gpio_setting led_spi_gpio;


void ledbar_init() {

	//spi pin
	led_spi_gpio.gpio_port[SPI_PIN_DS] = LEDBAR_DS_GPIO_Port;
	led_spi_gpio.gpio_port[SPI_PIN_SH] = LEDBAR_SH_GPIO_Port;
	led_spi_gpio.gpio_port[SPI_PIN_ST] = LEDBAR_ST_GPIO_Port;

	led_spi_gpio.gpio_pin[SPI_PIN_DS] =  LEDBAR_DS_Pin;
	led_spi_gpio.gpio_pin[SPI_PIN_SH] =  LEDBAR_SH_Pin;
	led_spi_gpio.gpio_pin[SPI_PIN_ST] =  LEDBAR_ST_Pin;

	spi_init(&led_spi_gpio);

	//HAL_GPIO_WritePin(GPIOB, LEDBAR_SH_Pin | LEDBAR_ST_Pin | LEDBAR_DS_Pin, RESET);
	HAL_Delay(100);
...
void ledbar_render(uint8_t inData) {
	...
	spi_tx_data(&led_spi_gpio, inData);
	spi_letch(&led_spi_gpio);
